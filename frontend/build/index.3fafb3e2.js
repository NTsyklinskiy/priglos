...
},{"./Timer.js":"6liX0","./Component.js":"4KuWp","./Listeners.js":"6qDN8","./controller.js":"BvQis","@parcel/transformer-js/lib/esmodule-helpers.js":"5gA8y"}],"6liX0":[function(require,module,exports) {
var _parcelHelpers = require("@parcel/transformer-js/lib/esmodule-helpers.js");
...
class Timer {
  ...
  startLogOutTimer() {
    const tick = () => {
      const labelTimer = document.querySelector(this.id), labelSec = labelTimer.querySelector('.seconds span '), labelMin = labelTimer.querySelector('.minuts span '), labelHours = labelTimer.querySelector('.hours span '), labelDays = labelTimer.querySelector('.days span '), time = Date.parse(this.endtime) - Date.parse(new Date()), sec = String(Math.floor(time / 1000 % 60)).padStart(2, 0), min = String(Math.floor(time / 1000 / 60 % 60)).padStart(2, 0), hours = String(Math.floor(time / (1000 * 60 * 60) % 24)).padStart(2, 0), days = String(Math.floor(time / (1000 * 60 * 60 * 24))).padStart(2, 0);
...
},{}],"4KuWp":[function(require,module,exports) {
var _parcelHelpers = require("@parcel/transformer-js/lib/esmodule-helpers.js");
_parcelHelpers.defineInteropFlag(exports);
class Component {
  constructor() {
...
},{"@parcel/transformer-js/lib/esmodule-helpers.js":"5gA8y"}],"6qDN8":[function(require,module,exports) {
var _parcelHelpers = require("@parcel/transformer-js/lib/esmodule-helpers.js");
_parcelHelpers.defineInteropFlag(exports);
class Listeners {
...
},{"@parcel/transformer-js/lib/esmodule-helpers.js":"5gA8y"}],"BvQis":[function(require,module,exports) {
var _parcelHelpers = require("@parcel/transformer-js/lib/esmodule-helpers.js");
_parcelHelpers.defineInteropFlag(exports);
  ...
  async controlLogin(user) {
    try {
      ...
      const addClass = function () {
        ...
        document.querySelector('.priglos__title').textContent = _modelJs.state.user.options;
      };
      addClass();
    } catch (err) {
      throw err;
...
},{"./model.js":"53sO2","./config.js":"5yJJr","core-js/stable":"1PFvP","regenerator-runtime/runtime":"62Qib","regenerator-runtime":"62Qib","@parcel/transformer-js/lib/esmodule-helpers.js":"5gA8y"}],"53sO2":[function(require,module,exports) {
var _parcelHelpers = require("@parcel/transformer-js/lib/esmodule-helpers.js");
_parcelHelpers.defineInteropFlag(exports);
...
var _helperJs = require("./helper.js.js");
const state = {
  user: {
    id: '',
    token: '',
...
},{"regenerator-runtime":"62Qib","./config.js":"5yJJr","./helper.js":"3PZsH","@parcel/transformer-js/lib/esmodule-helpers.js":"5gA8y"}],"62Qib":[function(require,module,exports) {
/**
...
const API_URL = document.location.href.startsWith("http://localhost") ? 'http://localhost:5000/' : '';
const TIMEOUT_SEC = 10;
const RES_PER_PAGE = 10;
const MODAL_CLOSE_SEC = 3;

},{"@parcel/transformer-js/lib/esmodule-helpers.js":"5gA8y"}],"3PZsH":[function(require,module,exports) {
var _parcelHelpers = require("@parcel/transformer-js/lib/esmodule-helpers.js");
_parcelHelpers.defineInteropFlag(exports);
...
},{"./config.js":"5yJJr","./model.js":"53sO2","@parcel/transformer-js/lib/esmodule-helpers.js":"5gA8y"}],"1PFvP":[function(require,module,exports) {
...
},{"../internals/export":"7f5VM"}]},["3Imd1","5rkFb"], "5rkFb", "parcelRequire0de8")
