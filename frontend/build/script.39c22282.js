...
})({"63009ce79ab01726e6d9217b7bb6d9c4":[function(require,module,exports) {
var global = arguments[3];
var HMR_HOST = null;
var HMR_PORT = 1234;
var HMR_ENV_HASH = "d751713988987e9331980363e24189ce";
module.bundle.HMR_BUNDLE_ID = "39c222826ee39d2abc319612b2e01cb2";
...
},{}],"67238ab5c9193247d0dcc2e892acb913":[function(require,module,exports) {
'use strict';

var _Timer = _interopRequireDefault(require("./Timer.js.js.js"));

var _Component = _interopRequireDefault(require("./Component.js.js.js"));

var _Listeners = _interopRequireDefault(require("./Listeners.js.js.js"));

var _controller = _interopRequireDefault(require("./controller.js.js.js"));

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

class App {
  static init() {
    _Timer.default.startLogOutTimer();

    _Component.default.fonAnim();

    const controller = new _controller.default();
    controller.handlerForm(controller.controlLogin);
    const navHover = new _Listeners.default('navigation', 'mouseover mouseout', '0.5 1');
    navHover.listenerHeader();
    const navClick = new _Listeners.default('header', 'click');
    navClick.listenerHeader();
    const navScroll = new _Listeners.default('', 'scroll', 'timer .priglos');
...
App.init();
},{"./Timer.js":"23661127d16f47fe18a1dbae1af87309","./Component.js":"319c2f205e702216a30349dc2b2bd29f","./Listeners.js":"37db0e3a497f677027fb62ac4bf2342d","./controller.js":"36bb694935dd05086a048288ecc1c354"}],"23661127d16f47fe18a1dbae1af87309":[function(require,module,exports) {
"use strict";
...
},{}],"319c2f205e702216a30349dc2b2bd29f":[function(require,module,exports) {
"use strict";
...
},{}],"37db0e3a497f677027fb62ac4bf2342d":[function(require,module,exports) {
"use strict";
...
var model = _interopRequireWildcard(require("./model.js.js.js"));
...
class Controller {
  constructor() {
    _defineProperty(this, "controlLogin", async user => {
      try {
...
},{"../internals/export":"10044f24ecae4059b4af184e71d3fba2"}],"ca81798027672ca9a54ff1b3bb2c3ca5":[function(require,module,exports) {
"use strict";
...
var _helper = require("./helper.js.js.js");
...
const signIn = async function (user) {
  try {
    const data = await (0, _helper.AJAX)(`${_config.API_URL}priglos/login`, user);
    console.log(data);
    state.user = {
      token: data.token,
...
},{"regenerator-runtime":"e155e0d3930b156f86c48e8d05522b16","./config.js":"787a7fa1a10c48c6aaba9830f0c930e8","./helper.js":"58d180f6f832f5cec928b79f35b75fe9"}],"e155e0d3930b156f86c48e8d05522b16":[function(require,module,exports) {
/**
...
},{}],"787a7fa1a10c48c6aaba9830f0c930e8":[function(require,module,exports) {
"use strict";
...
},{}],"58d180f6f832f5cec928b79f35b75fe9":[function(require,module,exports) {
"use strict";
...
exports.AJAX = AJAX;
},{"./config.js":"787a7fa1a10c48c6aaba9830f0c930e8","./model.js":"ca81798027672ca9a54ff1b3bb2c3ca5"}]},{},["63009ce79ab01726e6d9217b7bb6d9c4","67238ab5c9193247d0dcc2e892acb913"], null)

//# sourceMappingURL=script.39c22282.js.map
